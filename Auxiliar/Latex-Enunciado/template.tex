...
% Desde LaTeX 2025-06-01 amsmath define \numberwithin como copia de
% \counterwithin; el parche histórico solo debe aplicarse a formatos anteriores.
...
\usepackage{atbegshi}      % Reglas ejecutadas al despachar cada página
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={8.3.4-AUX},
		Template.Version.Hash={5E8505A0E7E1ECB27FE7625729CBC4A7},
	...
	pdfproducer={Template-Auxiliares v8.3.4 | (Pablo Pizarro R.) ppizarror.com},
...
% TeX Live 2026 exige valores booleanos ya expandidos para estas claves.
\begingroup
\edef\x{\endgroup
	\noexpand\hypersetup{%
