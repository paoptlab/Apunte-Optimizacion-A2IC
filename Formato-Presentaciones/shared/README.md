...
Recursos reutilizados por ambos decks Reveal.js:

- `deck.css`: tema visual y composiciones A2IC;
- `presentation-init.js`: inicialización común de Reveal.js y KaTeX;
